...
impl BuildAction for ConfigureBuild {
    ...
    fn files(&mut self, build: &mut impl FilesHandle) {
        ...
        // Only depend on .git when this checkout is its own git repo. In a
        // monorepo/submodule layout (e.g. anki/ nested inside a parent repo)
        // there is no anki/.git, and declaring a missing input makes n2 abort
        // with "input .git missing".
