...
preferences-changes-will-take-effect-when-you = Changes will take effect when you restart SpeedyCAT.
...
preferences-media-is-not-backed-up = Media is not backed up. Please create a periodic backup of your SpeedyCAT folder to be safe.
...
preferences-please-restart-anki-to-complete-language = Please restart SpeedyCAT to complete language change.
...
preferences-some-settings-will-take-effect-after = Some settings will take effect after you restart SpeedyCAT.
...
preferences-backup-explanation =
    SpeedyCAT periodically backs up your collection. After backups are more than 2 days old,
    SpeedyCAT will start removing some of them to free up disk space.
...
preferences-account = SpeedyCAT Account
...
preferences-ankiweb-intro = SpeedyCAT is a free service that lets you keep your flashcard data in sync across your devices, and provides a way to recover the data if your device breaks or is lost.
...
preferences-third-party-description = Third-party services are unaffiliated with and not endorsed by SpeedyCAT. Use of these services may require payment.
...
preferences-not-logged-in = Not currently logged in to SpeedyCAT.
