...
errors-addons-active-popup =
    ...
    An error occurred. Please start SpeedyCAT while holding down the shift key,
    ...
    Tools > Add-ons menu item to disable some add-ons and restart SpeedyCAT,
...
errors-accessing-db =
    ...
    interfering with SpeedyCAT. Try disabling such software and see if the
    problem goes away.
...
errors-unable-open-collection =
    SpeedyCAT was unable to open your collection file. If problems persist after restarting your computer, please use the Open Backup button in the profile manager.
