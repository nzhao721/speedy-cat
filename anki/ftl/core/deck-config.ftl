...
deck-config-bury-priority-tooltip =
    When SpeedyCAT gathers cards, it first gathers intraday learning cards, then
...
deck-config-display-order-will-use-current-deck =
    SpeedyCAT will use the display order from the deck you 
...
deck-config-disable-autoplay-tooltip =
    When enabled, SpeedyCAT will not play audio automatically.
...
deck-config-interval-modifier-tooltip =
    ...
    to make SpeedyCAT more conservative or aggressive in its scheduling. Please see
...
deck-config-maximum-answer-secs-above-recommended = SpeedyCAT can schedule your reviews more efficiently when you keep each question short.
...
deck-config-fsrs-tooltip =
    ...
    The Free Spaced Repetition Scheduler (FSRS) is an alternative to SpeedyCAT's legacy SuperMemo 2 (SM-2) algorithm.
...
deck-config-desired-retention-tooltip =
    By default, SpeedyCAT schedules cards so that you have a 90% chance of remembering them when
    they come up for review again. If you increase this value, SpeedyCAT will show cards more frequently
    to increase the chances of you remembering them. If you decrease the value, SpeedyCAT will show cards
...
deck-config-weights-tooltip2 =
    FSRS parameters affect how cards are scheduled. SpeedyCAT will start with default parameters. You can use 
...
deck-config-bury-tooltip =
    ...
    day. When enabled, SpeedyCAT will automatically *bury* siblings, hiding them until the next
...
deck-config-weights-tooltip =
    FSRS parameters affect how cards are scheduled. SpeedyCAT will start with default parameters. Once
...
deck-config-compute-optimal-weights-tooltip =
    Once you've done 1000+ reviews in SpeedyCAT, you can use the Optimize button to analyze your review history,
